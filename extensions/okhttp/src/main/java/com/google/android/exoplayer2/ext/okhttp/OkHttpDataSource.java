...
public class OkHttpDataSource implements HttpDataSource {
  ...
  @NonNull private  Call.Factory callFactory;
  @NonNull private  RequestProperties requestProperties;

  @Nullable private  String userAgent;
  @Nullable private  Predicate<String> contentTypePredicate;
  @Nullable private  TransferListener<? super OkHttpDataSource> listener;
  @Nullable private  CacheControl cacheControl;
  @Nullable private  RequestProperties defaultRequestProperties;
  ...
  public OkHttpDataSource(RequestProperties defaultRequestProperties, TransferListener<? super OkHttpDataSource> listener){
